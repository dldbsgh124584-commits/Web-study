  ...
  <div class="row">
   <h1>JSP에서 지원한 내장객체:미리 생성된 객체</h1>
    <table class="table">
     ...
     <tr>
      <td>request(HttpServeltRequest)</td>
      <td>요청하는 동안</td>
    ...
    <table class="table">
     ...
     <tr>
      ...
      <td>클라이언트가 보낸 요청 데이터를 모아서 전송(쿠키읽기,세션 읽기)</td>
      <td>
         <ul>
          <li>***getParameter():다중값</li>
      ...
      <tr>
       ...
       <td>
         <ul>
          ...
          <li>***getRealPath(): 실제 톰캣에서 읽은 파일 : 소프트웨어 이행</li>
            <br>
