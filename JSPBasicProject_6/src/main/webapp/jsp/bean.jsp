...
<%--
      ...
      3. ConnectionPool
      ----------------------- Spring-Boot
      JSP(HTML변경이 가능 => 데이터번경 (한파일에서 여러개를 수행 = 동적 페이지)
         화면 출력 : HTML  데이터 변경 : 자바
         -----------------------------
            HTML + Java => 복잡하다 (분리할 수 없다 : 여러명이 동시 작업이 불가능)
                                   -------------------------  협업 할 땐 HTML 따로 , Java 따로 작업   
     ...
     1. JSP 지시자
         ...
         ***request : 클라이언트 요청 정보 => 사용자가 전송한 데이터를 담은 클래스
