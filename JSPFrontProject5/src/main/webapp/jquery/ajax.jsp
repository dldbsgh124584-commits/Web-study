...
// 서버에 전송 => 수신 => $.ajax({method:...}):jquery / fetch(Vue) / axios()
function sendRequest(url,params,callback,method)
{
   ...
   // 2. method 방식 지정
   let httpMethod=method?method:'GET' // default : GET  = method || 'GET';
   ...
   // open => 이미 제작됨 => 서버 연결시 사용 => true (Asyne 비동기적)
   // 6. 데이터 전송
   // 한글 처리
