<%@ page language="java" contentType="text/html; charset=UTF-8"
    pageEncoding="UTF-8"%>
<%--
     *** 새로고침/화면 이동 => request는 초기화 => 한 번 사용후에 버림
     ...
     1) 클래스
        ...
        1. 서버 정보
           ...
           getRequestURI()
           getContextPath()
     http://localhost/JSPBasicProject_3/jsp_3/object_165.jsp => URL
     ---------------- --------------------------------------
         서버 정보             클아이언트 요청 정보
     1) getServerName() : localhost
     2) getProtocol() : http => 80
     3) getRequestURL()
     4) getRequestURI() : JSPBasicProject_3/jsp_3/object_165.jsp
     5) getContextPath() : JSPBasicProject_3/jsp_3
