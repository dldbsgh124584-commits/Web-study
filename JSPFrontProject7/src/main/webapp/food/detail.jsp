...
<body>
 <div class="container">
  <div class="row">
   <table class="talbe">
    <tr>
     <td width=40% class="text-center" rowspan="8"><img src="${vo.poster }" style="width:320px;height:350px;object-fit:cover">
     </td>
     <td colspan="2">
    ...
    <tr>
     <td colspan="3" class="text-right"><a href="../main/main.do" class="btn btn-xs btn-info">목록</a>
     </td>
    </tr>
   </table>
  </div>
    ...
    <table class="table">
     ...
     <tr>
      <td>
        ...
        <textarea name="msg" rows="4" cols="90" style="float: left" name="msg"></textarea>
        <button type=submit class="btn-primary" style="width:100px;height: 93px;float: left">댓글쓰기</button>
      </td>
     </tr>
     </form>
    </table>
