...
const search=async(fd)=>{
	try
	{
		...
		const response = await fetch('https://youtube.googleapis.com/youtube/v3/search?part=snippet&maxResults=28&q='+fd+'&type=video&key=AIzaSyCb5n0aM0khqJc3heu64gtvU_Dh5kaErjk')
		...
		movie.forEach((m)=>{
			html+='<div class="col-sm-4">'
			     +'<div class="thumbnail">'
			     +'<embed src="https://www.youtube.com/embed/'+m.id.videoId+'" style="width:350px;height:250px"></embed>'
			     +'</div>'
			     +'<p>'+m.snippet.title+'</p>'
			     +'</div>'
		})
