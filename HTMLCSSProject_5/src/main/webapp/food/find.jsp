...
<body>
  <div class="container">
   <div class="row text-center">
    <form action="find.jsp" method="post"><!-- 전송 데이터 한번에 묶어서 보냄 : input / textarea / select  
               속성
                => method : 공개/비공개
                            GET / POST => 생략하면 GET방식이다                          
                => action : 어떤 파일로 보낼지 설정
                ?page=1&type=한식
                
                => id , class : CSS / JavaScript에서 태그제어
                => name : JSP / Servlet으로 값을 전송
                
                selected / checked / readonly / required / placeholer
                                     text       text       text
