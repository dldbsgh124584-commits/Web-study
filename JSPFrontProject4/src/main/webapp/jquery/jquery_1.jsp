...
$(function(){
	...
	$('img').hover(function(){
		$(this).css({
			"cursor":"pointer","border":"3px solid green"
		})
	},function(){$(this).css({
...
<body>
 ...
 <img src="https://img.megabox.co.kr/SharedImg/2026/05/20/pmZQuVk4GTvGL0OGU4mkE2IfrwDAHLfk_420.jpg">
