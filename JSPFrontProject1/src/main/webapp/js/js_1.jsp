...
<%--
      자바 스크립트
       ...
       특징 
         = 인터프리터 (컴파일을 하지 않는다) => 한줄씩 읽어서 출력하는 방식
           ** 에러 처리가 어렵다 => 개발자 도구
         = 동적 페이지 : 화면 변경이 없이 그 자리에서 처리
         = 비동기 처리가 거능
       ...
       용도 : 동적 페이지 제작 , 서버 개발 , 웹 개발 
       실행환경 : 브라우저에서만 실행
       특징 : 인터프리터 / 객체기반 / 이벤트 중심
  ...
  연결하려면 중간에 자바 넣는다  자바스크립트 ================== 자바 ==================== 오라클 
