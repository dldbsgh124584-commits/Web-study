...
function ok()
{
   ...
   if(frm.pwd.value!==frmpwd1.value)
   {
	   alert("비밀번호가 틀립니다!!")
	   return
   }
...
<body>
  <form name="frm">
   ...
   Password:<input type=pawwsord name=pwd size=15><br>
