               ...
               <div class="row no-gutters">
                 <div class="col-12 col-sm-12">
                                  ...
                                  <div class="related-post-area section_padding_50"> 
                                   <div class="related-post-slider owl-carousel padding_50">
                            ...
                            <table class="table">
                              <tr>
                                <td width=40% class="text-center" rowspan="10" valign="middle">
                                  <img src="${vo.poster}" style="width: 100%;height:350px;object-fit:cover" class="img-rounded">
                                </td>
                              </tr>
                              <tr>
                               <td colspan="2">
                            ...
                            <table class="table">
                             <tr>
                              <td>
                                 ...
                                 <script type="text/javascript" src="//dapi.kakao.com/v2/maps/sdk.js?appkey=90a64b2b354bc33bb1c682bf9dcaab49&libraries=services"></script>
									<script>
