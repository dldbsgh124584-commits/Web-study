                    ...
                    <div class="signup-search-area d-flex align-items-center justify-content-end">
                        <div class="login_register_area d-flex">
                          <c:if test="${sessionScope.id==null }">
                            ...
                            <div class="logout">
                            <span>
                             <strong class="welcome">${sessionScope.name }(${sessionScope.admin=='y'?"관리자":"일반 사용자" })님 환영합니다</strong>
                            </span>
                                <a class="btn-xs btn-danger btn link" href="../member/logout.do" id="logout" style="margin-left: 5px">로그아웃</a>
                            </div>
                            </c:if>
                        </div>
                        <!-- Search Button Area -->
                            ...
                            <ul class="navbar-nav" id="yummy-nav">
                                ...
                                <li class="nav-item dropdown">
                                    ...
                                    <div class="dropdown-menu" aria-labelledby="yummyDropdown">
                                        ...
                                        <a class="dropdown-item" href="../tour/travel.do?contenttypeid=15&areaCode=1">행사/축제/공연</a>
                                ...
                                <li class="nav-item dropdown">
                                    ...
                                    <div class="dropdown-menu" aria-labelledby="yummyDropdown">
                                        ...
                                        <a class="dropdown-item" href="../tour/travel.do?contenttypeid=15&areaCode=6">행사/축제/공연</a>
                                ...
                                <li class="nav-item dropdown">
                                    ...
                                    <div class="dropdown-menu" aria-labelledby="yummyDropdown">
                                        ...
                                        <a class="dropdown-item" href="../tour/travel.do?contenttypeid=15&areaCode=39">행사/축제/공연</a>
