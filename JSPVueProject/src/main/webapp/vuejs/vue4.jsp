...
<body>
 ...
 <div class="container">
  <div class="row">
    ...
    <button type="button" class="btn-sm btn-primary" @click="select(5)">기내식</button>
  </div>
 ...
 <div class="row text-center" style="margin-top:10px">
  <button class="btn btn-lg btn-danger" @click="log()">로그인</button>
  <button class="btn btn-lg btn-primary" @click="logout()">로그아웃</button>
  <div v-if="login===true">
    <h3>로그인 되었습니다</h3>
  </div>
  <div v-else>
